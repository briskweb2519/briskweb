    ...
    constructor(props){
        ...
        this.state = {
            data : [
                ...
                {id : 3, img : Pricing, name : "Transparent Pricing", description : "The price will be fully transparent at any stage of the project. That means: We will usually not charge on an hourly basis, but rather we will agree on a fixed price. Only if the scope of the project changes will the price be adjusted accordingly with prior agreement. Therefore it is always clear on what the final price will be, and there will be no surprises."},  
            ]
        }
    }
    render(){
