...
import Nutan1 from '../Images/Nutan/Nutan1.png'
import Nutan2 from '../Images/Nutan/Nutan2.png'
import Nutan3 from '../Images/Nutan/Nutan3.png'
          ...
          <Paper className={classes.paper}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6} style={{ paddingTop: '7%' }}>
                <div className="trans">
                  <img alt="complex" src={data.img3} style={{ width: '35%', height:'200px', border: '1px solid' }} />
                </div>
                <div className="avatar">
                  <div className="trans">
                    <img alt="complex" className="trans1" src={data.img2} style={{ width: '30%',height:'100px', border: '1px solid' }} />
                  </div>
                </div>
                <div className="avatar">
                  <div className="trans">
                    <img alt="complex" className="trans2" src={data.img1} style={{ width: '30%',height:'200px', border: '1px solid', position: 'absolute' }} />
                  </div>
                </div>
              </Grid>
            </Grid>
